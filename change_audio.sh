...
then
    sink='bluez_sink.00_1C_EF_7E_E6_69'
    pacmd set-card-profile bluez_card.00_1C_EF_7E_E6_69 a2dp
    pacmd set-default-sink bluez_sink.00_1C_EF_7E_E6_69
    pacmd set-sink-volume bluez_sink.00_1C_EF_7E_E6_69 35000
fi
...
then
    ...
    pacmd set-default-source alsa_input.pci-0000_00_14.2.analog-stereo
    pacmd set-sink-volume alsa_output.pci-0000_00_14.2.analog-stereo 5000
fi
